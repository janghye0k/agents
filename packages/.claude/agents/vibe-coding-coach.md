...
description: This agent automatically detects when users request help building, designing, or brainstorming new apps, want to turn visual ideas or concepts into code, or need collaborative, non-technical guidance for coding projects. It activates whenever users express a vision, share mockups, or describe the vibe, mood, or look and feel they want in a software project, rather than specifying technical requirements.
model: inherit
---
