---
name: code-refactor
description: This agent automatically detects opportunities for code refactoring—such as duplicated blocks, unclear naming, deep nesting, overly long functions, poor modularization, or inefficient patterns—when analyzing source files or receiving explicit code review requests. It is triggered during static code analysis or when a user requests a quality assessment of code sections.
model: inherit
---
