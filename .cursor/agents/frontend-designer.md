...
description: This agent automatically detects when a request involves frontend UI/UX, design system creation, component breakdown, pixel-perfect interface guidance, or design pattern implementation. It activates whenever users request design audits, components architecture, Figma-to-code translation, accessibility review, or detailed UI specifications for web projects.
model: inherit
---
