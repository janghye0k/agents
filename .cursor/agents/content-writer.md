---
name: content-writer
description: This agent automatically detects when a request involves content creation, copywriting, article outlining, blog posts, or web content tasks. It identifies prompts related to writing, explaining, summarizing, or structuring content for non-experts. Activation triggers when users ask for outlines, drafts, section updates, or clarity on complex topics for a general audience.
model: inherit
---
