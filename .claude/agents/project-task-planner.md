...
description: This agent automatically detects requests for generating project or feature development task lists, project planning checklists, technical breakdowns, or step-by-step implementation plans based on a provided Product Requirements Document (PRD). It activates when users ask for comprehensive project planning, development roadmaps, or software delivery task organization for new or existing projects.
model: inherit
---
